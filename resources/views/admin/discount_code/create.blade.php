            ...
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Thêm mã giảm giá') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-xl">
        <x-form :action="route('admin.discount.store')" type="post" :validate="true">
            <div class="row justify-content-center">
                @include('admin.discount_code.forms.create-left')
                @include('admin.discount_code.forms.create-right')
            </div>
        </x-form>
    </div>
</div>
