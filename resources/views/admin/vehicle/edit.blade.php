            ...
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Sửa phương tiện') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="page-body">
    <div class="container-xl">
        <x-form :action="route('admin.vehicle.update')" type="put" :validate="true">
            <x-input type="hidden" name="id" :value="$vehicle->id" />
            <div class="row justify-content-center">
                @include('admin.vehicle.forms.edit-left')
                @include('admin.vehicle.forms.edit-right')
            </div>
        </x-form>
    </div>
</div>
