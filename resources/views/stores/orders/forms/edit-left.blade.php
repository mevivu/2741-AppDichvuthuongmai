        ...
        <div class="row card-body">
            ...
            <div class="col-md-6 col-12">
                <div class="mb-3">
                    ...
                    <x-input type="date"
                             name="created_at"
                             disabled
                             :value="format_date($order->created_at, 'Y-m-d')"
                             :required="true"/>
                </div>
            </div>
            <!-- pickup_address -->
            ...
            <div class="col-md-6 col-12 mt-3">
                <div class="mb-3">
                    ...
                    <x-select disabled name="shipping_method" :required="true">
            ...
            <div class="col-md-6 col-12 mt-3">
                <div class="mb-3">
                    ...
                    <x-select disabled name="payment_method" :required="true">
            ...
            <div class="col-md-6 col-12">
                <div class="mb-3">
                    ...
                    <x-input-price id="discount_amount"
                                   disabled
            ...
            <div class="col-md-6 col-12">
                <div class="mb-3">
                    ...
                    <x-input-price id="transport_fee"
                                   name="transport_fee"
                                   disabled
            ...
            <div class="col-md-6 col-12">
                <div class="mb-3">
                    ...
                    <x-input-price id="system_revenue"
                                   name="system_revenue"
                                   disabled
                                   :value="$order->system_revenue"
                                   :required="true"/>
                </div>
            </div>
            <!-- total -->
