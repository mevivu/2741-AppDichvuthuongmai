...
namespace App\Store\Http\Controllers\Page;
...
class PageController extends Controller
{
    ...
    public function getView(){
        ...
        return [
            'index' => 'stores.pages.index',
            'create' => 'stores.pages.create',
            'edit' => 'stores.pages.edit'
        ];
    }
    ...
    public function getRoute(){
        ...
        return [
            'index' => 'store.page.index',
            'create' => 'store.page.create',
            'edit' => 'store.page.edit',
            'delete' => 'store.page.delete'
        ];
    }
